...
int main() {
    ...
    /*
     * cout << chrono::system_clock::period::num << "/" << chrono::system_clock::period::den <<
     * endl; cout << chrono::steady_clock::period::num << "/" << chrono::steady_clock::period::den
     * << endl; cout << chrono::high_resolution_clock::period::num << "/" <<
 ...
 * time_point<system_clock, milliseconds>:  according to system_clock, the elapsed time since epoch
 in milliseconds
 *
 * typdefs
