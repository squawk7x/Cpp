...
public:
    dogGen() {
    } // 1. call base class default constructor
      // 2. call data members default constructor
    dogGen(const dogGen& rhs) {
    } // Member by member initialization
    dogGen operator=(const dogGen& rhs) {
...
5. Move constructor	    if no destructor, no copy constructor and no copy nor move assignment	moves all members
6. Move assignment	    if no destructor, no copy constructor and no copy nor move assignment	moves all members
