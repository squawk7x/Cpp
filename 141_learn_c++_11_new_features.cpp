...
//     Dog11_2(int a) { // 2nd choice
//         age = a;
//     }

//     Dog11_2(const initializer_list<int> &vec) { // 1st choice
//         age = *(vec.begin());
...
// int main() {
//     Dog11 a(2);
//     // Dog11 b(3.0); // 3.0 is converted from double to int
//     Dog11 c;
//     // a = c;        // Compiler generated assignment operator
// }
